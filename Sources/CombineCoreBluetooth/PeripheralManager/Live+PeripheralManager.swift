...
extension PeripheralManager {
    public static let RestoreIdentifierKey = "CombineCoreBluetoothRestoreIdentifier"
    public static var live: Self {
        ...
        #else
        let options: [String: Any] = [CBPeripheralManagerOptionRestoreIdentifierKey: RestoreIdentifierKey]
        let peripheralManager = CBPeripheralManager(delegate: delegate,
                                                    queue: DispatchQueue(label: "com.combine-core-bluetooth.peripheral"),
                                                    options: options)
        #endif
        return Self(
            delegate: delegate,
